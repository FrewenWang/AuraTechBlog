---
title: Java集合类学习之HashMap基础知识学习（基于JDK1.8.0_181）
date: 2019-01-13 21:00:35
tags: [Java,HashMap,集合]
---


文章参考 [https://tech.meituan.com/2016/06/24/java-hashmap.html](https://tech.meituan.com/2016/06/24/java-hashmap.html)
...
```
    ...
    final V putVal(int hash, K key, V value, boolean onlyIfAbsent,
        ...
        // i = (n-1)&hash 计算index值。如果为null 那么通过newNode来构建hash桶的这个节点
